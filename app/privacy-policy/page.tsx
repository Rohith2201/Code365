export default function PrivacyPolicyPage() {
  return (
    <div className="max-w-4xl mx-auto space-y-8 bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900 p-8 rounded-lg shadow-lg">
      <h1 className="text-4xl font-bold mb-8 text-center text-gradient-primary">Privacy Policy</h1>
      <title>Privacy Policy - Code 365</title>
      <meta name="description" content="Code 365 Privacy Policy" />
      <meta name="keywords" content="Privacy Policy, Code 365" />
      ...
      <section>
        ...
        <p>We use the information we collect to provide, maintain, and improve our services, to communicate with you, and to personalize your experience on Code 365.</p>
      </section>
      ...
      <section>
        ...
        <p>If you have any questions about this privacy policy, please contact us at privacy@code365.com.</p>
      </section>
    </div>
  )
}
